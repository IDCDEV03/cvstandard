                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            ...
                            <div class="dm-button-list d-flex flex-wrap">
                                <a href="{{ route('company.form.back_to_create3', ['id' => $cates_data->form_id]) }}"
                                ...
                                @else
                                    <a href="{{ route('company.form.ItemCreate', ['id' => request()->cates_id]) }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group dm-button-group btn-group-normal my-2"
                                                            role="group">
                                                            <a href="{{ route('staff.item_edit', ['id' => $data->item_id]) }}"
