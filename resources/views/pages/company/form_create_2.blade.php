...
@php
    ...
    if ($order > '1') {
        $text_title = 'เพิ่มหมวดหมู่';
    }
    elseif($order <= '1') {
        $text_title = 'สร้างหมวดหมู่';
    }      
@endphp
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">@php
                            echo $text_title;
                        @endphp                          
                        </h4>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-25">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{route('company.form.store2',['id'=>request()->id])}}" method="POST">
                                @csrf
                                <input type="hidden" name="cates_no[]" value="
                                @php
                                   echo $more_order
                                @endphp" class="order-field">
