...
<div class="container-fluid">
        ...
        <div class="col-md-12">
            <div class="card mb-25">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('company.pre_inspection.store') }}" method="POST" id="templateForm">
                        @csrf
                        ...
                        <div id="fields_container">
                            <div class="row mb-3 field-row align-items-end">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="fields[0][field_label]" class="form-control ih-medium ip-gray radius-xs" placeholder="เช่น ภาพหน้ารถ / ภาพผู้ตรวจรถ" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">ประเภทการกรอกข้อมูล</label>
                                    <select name="fields[0][field_type]" class="form-select ih-medium ip-gray radius-xs" required>
 ...
 <div class="border-top my-4"></div>
                        <div class="layout-button mt-25">
                            <button type="submit" class="btn btn-primary btn-default btn-squared">บันทึกแม่แบบ</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        addBtn.addEventListener('click', function() {
            const newRow = `
                <div class="row mb-3 field-row align-items-end">
                    ...
                    <div class="col-md-2">
                        <button type="button" class="btn btn-danger btn-sm w-100 remove-row">ลบ</button>
                    </div>
                </div>
            `;
