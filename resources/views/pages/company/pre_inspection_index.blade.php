    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="breadcrumb-main d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('company.pre_inspection.create') }}" class="btn btn-primary btn-default btn-squared">
                            ...
                            <tbody>
                                @forelse ($templates as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('company.pre_inspection.show', $item->id) }}" class="btn btn-info btn-sm btn-squared">
