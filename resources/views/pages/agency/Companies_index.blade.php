                        ...
                        <div class="row g-2">
                            <div class="col-md-6">
                                <input type="text"
                                       ...
                                       placeholder="ค้นหาด้วยรหัสบริษัท / ชื่อบริษัท / จังหวัด">
                            </div>
                            <div class="col-md-2">
                            ...
                            <tbody>
                                @forelse($companies as $index => $row)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-semibold">{{ $row->company_id }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-primary">{{ $row->form_limit ?? 0 }}</span>
                                        </td>
                                        <td class="text-center">
                                            ...
                                            @elseif($row->require_user_approval == '0')
                                                <span class="dm-tag tag-warning tag-transparented fs-18">รออนุมัติ</span>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <form action="{{ route('companies.destroy', $row->id) }}"
                                                      method="POST"
                                                      onsubmit="return confirm('ยืนยันการลบบริษัทนี้ ?')"
                                                      class="d-inline">
                                                    @csrf
