        ...
        <div class="col-md-4">
            ...
            <div class="card mb-3">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <span class="fw-500 fs-14">ข้อมูลส่วนตัว</span>
                </div>
                        ...
                        @foreach($documents as $doc)
                            <div class="d-flex align-items-center gap-3 py-2
                                ...
                                <div class="d-flex align-items-center justify-content-center rounded flex-shrink-0"
                                    ...
                                    <i class="fs-16 {{ $doc->file_extension === 'pdf'
                                        ? 'lar la-file-pdf' : 'lar la-file-alt' }}"
...
<div class="modal fade" id="modalUploadDoc" tabindex="-1" aria-labelledby="modalUploadDocLabel">
    <div class="modal-dialog">
        <form method="POST"
              action="{{ route('drivers.documents.store', $driver->driver_id) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="doc_file" id="modal-file-input"
                               accept=".pdf,.docx" class="form-control form-control-sm" required>
