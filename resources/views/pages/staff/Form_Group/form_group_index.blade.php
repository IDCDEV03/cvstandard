            ...
            <div class="card mt-20  mb-25">
                <div class="card-body">
                    <div class="dm-button-list d-flex flex-wrap gap-2">
                        <a href="{{ route('staff.form-group.create') }}" class="btn btn-primary btn-transparent-primary fs-16">
                            ...
                            <tbody>
                                @foreach ($formGroups as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('staff.form-group.show', ['id' => $item->form_group_id]) }}">
                                        ...
                                        <td>
                                            <a href="{{ route('staff.form-group.show', ['id' => $item->form_group_id]) }}" class="btn btn-info btn-sm text-white">
