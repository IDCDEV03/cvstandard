    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="breadcrumb-main d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{route('staff.report_template.create')}}" class="btn btn-primary btn-default btn-squared">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="orderEdit-wrap d-flex justify-content-center mb-0">
                                                <li>
                                                    <a href="{{ route('staff.report_template.show', $item->id) }}" class="view" title="ดูรายละเอียด">
